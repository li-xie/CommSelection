...
N = 100; % to allow parent community to reproduce as many offspring as possible 
...
for j = 1:100
    ...
    comm_all = cell_sort(comm_selected, comm_struct, const_struct, dil_factor, 0, rep_counter, j);
