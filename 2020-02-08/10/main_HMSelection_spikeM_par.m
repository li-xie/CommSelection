...
%     save([folder_name2 '/adults'],'adults');
    ...
    for i = 1 : comm_type_num*comm_rep_num
        ...
        [comm_all(rep_counter+1:comm_all_idx), M_isolates_out(i)]...
            = repro_method(comm_all_sorted(i), comm_struct, const_struct, dil_factor, ...
            spike_frac, M_isolates_in(comm_all_sorted(i).parentnum), rep_counter, i);
