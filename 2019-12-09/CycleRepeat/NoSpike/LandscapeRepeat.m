...
%%
figure(1)
% (min(p(:)):max(p(:))/50:max(p(:)))
contour((x0:dx:xt),(y0:dy:yt),pp,(250:50:1e3),'linewidth',2)
...
load('ContourLine')
plot(C(1, 2:end), C(2, 2:end)*(1-spike_frac),  'color', [1 0.2 0], 'linewidth', 3)
...
plot([mean(fp0_sel(r,:)) mean(fp0_all(r,:))],[0.55 0.55],'o')
