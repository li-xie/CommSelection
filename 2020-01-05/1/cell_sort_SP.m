...
function comm_rep = cell_sort_SP(comm_selected, comm_struct, const_struct,...
...
gM_max_rand = gM_max(rand_idx1);
K_MB_rand = K_MB(rand_idx1);
K_MR_rand = K_MR(rand_idx1);
H_L_rand = H_L(rand_idx2);
gH_max_rand = gH_max(rand_idx2);
K_HR_rand = K_HR(rand_idx2);
...
if dil_factor >= comm_rep_num
    for i = 1 : comm_rep_num
        ...
        if M_num>=1
            ...
            comm_rep(i).gM_max(1:M_num) = gM_max_rand(par_idx1(i)+1:par_idx1(i+1));
            comm_rep(i).K_MB(1:M_num) = K_MB_rand(par_idx1(i)+1:par_idx1(i+1));
            comm_rep(i).K_MR(1:M_num) = K_MR_rand(par_idx1(i)+1:par_idx1(i+1));
        end
        if H_num>=1
            comm_rep(i).H_L(1:H_num)= H_L_rand(par_idx2(i)+1:par_idx2(i+1));
            comm_rep(i).gH_max(1:H_num)= gH_max_rand(par_idx2(i)+1:par_idx2(i+1));
            comm_rep(i).K_HR(1:H_num)= K_HR_rand(par_idx2(i)+1:par_idx2(i+1));
        end
